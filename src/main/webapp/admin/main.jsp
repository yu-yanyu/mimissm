	...
	<body>
		...
		<div id="all">
			...
			<div id="bottom">
				...
				<div id="bleft">
					...
					<div id="lbottom">
						<ul>
							...
							<a href="${pageContext.request.contextPath}/orders/split.action?page=1" target="myright">
				...
				<!--下部分右边-->
				<div id="bright">
					<iframe frameborder="0" scrolling="no" name="myright" width="1235px" height="700px" src="${pageContext.request.contextPath}/prod/split.action" ></iframe>
				</div>
			</div>
		</div>
	</body>
